...
<html>
  ...
  <body>
    <header class="header">
                    ...
                    <div class="block margin-bottom-sm" style="width:1000px;">
                      ...
                      <table class="table" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row"><?php echo e($candidate->Uid); ?></th>
                            ...
                            <td>
                              ...
                              <td><a style="color:#78ff85; padding-left: 20px" href='/changeStatususers/<?php echo e($candidate->Uid); ?>/1'>Allow</a></td>
                              <td><a style="color:#ff1f1f; padding-right: 20px"  href='/changeStatususers/<?php echo e($candidate->Uid); ?>/-1'>Deny</a></td>
                            </tr>
      ...
      </html><?php /**PATH C:\Laravel\ovs\resources\views/usersTables.blade.php ENDPATH**/ ?>