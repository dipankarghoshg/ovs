    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img src="/img/<?php echo e(Session('Image')); ?>" style="height: 50px; " alt="..." class="img-fluid rounded-circle"></div>
          <div class="title">
            <h1 class="h5"><?php
                              echo session('Name'); 
...
$data=com_model::all(); 
        $WCS=DB::table('Candidate_models')
             ->where('Name',$data[0]->WinnerCS)->get();
?>
<form name="Results">
...
$data=com_model::all(); 
        $WACS=DB::table('Candidate_models')
             ->where('Name',$data[0]->WinnerACS)->get();
?>
...
$data=com_model::all(); 
        $WAGS=DB::table('Candidate_models')
             ->where('Name',$data[0]->WinnerAGS)->get();
?>
...
</html><?php /**PATH C:\Laravel\ovs\resources\views/Results.blade.php ENDPATH**/ ?>