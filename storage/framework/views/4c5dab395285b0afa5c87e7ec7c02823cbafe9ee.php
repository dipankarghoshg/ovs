        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="/views/user.blade.php"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="/views/vote.blade.php" > <i class="menu-icon fa fa-tasks"></i>Give_vote</a>
...
<?php /**PATH C:\Laravel\Project_Major\resources\views/user.blade.php ENDPATH**/ ?>