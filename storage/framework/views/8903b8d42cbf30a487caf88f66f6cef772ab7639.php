...
<html>
  <head>
    ...
    <title>Ovs- Commissioner Login</title>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  ...
                  <p>Just login and you are good to go to Decorate the Election!</p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form method="post" class="form-validate" action="/logincmm/varify">
                    ...
                    <button class="btn btn-primary" id="login" value="Login" style="width: 60px; height: 35px;">Login</button><br>
                    <?php echo e(csrf_field()); ?>

                    <!-- This should be submit button but I replaced it with <a> for demo purposes-->
                    <!-- </form><a href="#" class="forgot-pass">Forgot Password?</a><br> --><small>Do not have an account? </small><a href="/views/cmmRegistration.blade.php" class="signup">Signup</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  </html><?php /**PATH C:\Laravel\ovs\resources\views/loginCommissioner.blade.php ENDPATH**/ ?>