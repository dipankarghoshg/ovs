...
<html>
    ...
    <body>
        ...
        <?php
        use App\com_model;
        $data=DB::table('com_models')
        ->where('Email',session('Email'))->get();
        ?>
        <div class="login-box">
            <form name="f2" method="post" action='/cmmUpdate/<?php echo e($data[0]->Id); ?>' enctype="multipart/form-data" >
                <img src="/img/<?php echo e(Session('Image')); ?>" name="Image" class="avatar">
             ...
             <a href="/views/cmm.blade.php"><input type="submit" name="submit" value="Back"></a>
        </div>
...
</html><?php /**PATH C:\Laravel\ovs\resources\views/cmmUpdate.blade.php ENDPATH**/ ?>