        ...
        <ul class="nav navbar-nav">
          ...
          <div id="right-panel" class="right-panel">
            ...
            <header id="header" class="header">
              ...
              <form name="pags" action="/postags">
                <table>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" name="AGS" value="<?php echo e($candiag->Cid); ?>"></td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  
                </table>
                <center>
                <button class="btn-full"><span style="color: white;"></span>Submit</button>
                </center>
              </form>
              <?php
              ...
              if(isset($_POST["AGS"]))
              {
              $selection= test_input($_POST["AGS"]);
              }
              else
              {
              ...
              <!--=========================================script============================================--><?php /**PATH C:\Laravel\ovs\resources\views/voteAGS.blade.php ENDPATH**/ ?>