      ...
      <div id="main-menu" class="main-menu collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="menu-item-has-children dropdown">
            ...
            <li class="menu-item-has-children dropdown">
              ...
              <div id="right-panel" class="right-panel">
                ...
                <header id="header" class="header">
                  ...
                  <!--/.Content -->
                  <center>
                  <div class="winner" style=" font-family: 'Open Sans', sans-serif;  font-size: 35px; background-color: white; ">
                    <?php
                    $win=Com_model::all();
                    if ($win[0]->WinnerCS== session('CollegeId')) {
                    ?><i class="fas fa-trophy" style="color: #ffaf19;"></i>Congratulations! for Your Victory.<i class="fas fa-fire" style="color: #fc0000;"></i><?php
                    }
                    elseif ($win[0]->WinnerACS== session('CollegeId')) {
                    ?><i class="fas fa-trophy" style="color: #ffaf19;"></i>Congratulations! for Your Victory.<i class="fas fa-fire" style="color: #fc0000;"></i><?php
                    }
                    if ($win[0]->WinnerAGS== session('CollegeId')) {
                    ?><i class="fas fa-trophy" style="color: #ffaf19;"></i>Congratulations! for Your Victory.<i class="fas fa-fire" style="color: #fc0000;"></i><?php
                    }
                    else{
                    }
                ...
                box-shadow: 0 12px 16px 0 rgba(0,0,0.50),0 17px 50px 0 rgba(0,0,0.40);
                  ...
                  ?>
                  <form name="Results">
                    <?php $__currentLoopData = $WCS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card">
                      <img src="/images/<?php echo e($candidate->Image); ?>" alt="Avatar" style="width:100%">
                      <div class="container">
                        <h4><b><?php echo e($candidate->Name); ?></b></h4>
                        <p>POST :- <?php echo e($candidate->Post); ?></p>
                        <p>has won With<?php echo e($candidate->Vote); ?> votes.</p>
                      </div>
                    </div>
                    ...
                    ?>
                    <?php $__currentLoopData = $WACS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card">
                      <img src="/images/<?php echo e($candidate->Image); ?>" alt="Avatar" style="width:100%">
                      <div class="container">
                        <h4><b><?php echo e($candidate->Name); ?></b></h4>
                    ...
                    ?>
                    <?php $__currentLoopData = $WAGS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card">
                      <img src="/images/<?php echo e($candidate->Image); ?>" alt="Avatar" style="width:100%">
                      <div class="container">
                        <h4><b><?php echo e($candidate->Name); ?></b></h4>
                  ...
                  <center>
                   </a><button class="btn-rs" style="font-family: 'Open Sans', sans-serif; font-size: 20px;"><a href="/views/fullResults.blade.php"> See Full Results</button></a>
                  </center>
                  <!-- /.content -->
            ...
            </html><?php /**PATH C:\Laravel\ovs\resources\views/CandidateResults.blade.php ENDPATH**/ ?>