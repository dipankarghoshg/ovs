...
<html>
    ...
    <body>
        ...
        ?>
        <div class="login-box">
            <form name="f2" method="post" action='/UpdateProfile/<?php echo e($data[0]->Uid); ?>' enctype="multipart/form-data" >
                <img src="/images/<?php echo e(session('Image')); ?>" name="Image" class="avatar">
                ...
                'Email')?>" readonly>
                <p>CollegeId</p>
                <input type="text" name="CollegeId" placeholder="Enter Your College Id" value="<?php echo e(Session('CollegeId')); ?>"readonly>
                <p>Stream</p>
...
</html><?php /**PATH C:\Laravel\ovs\resources\views/UserProfile.blade.php ENDPATH**/ ?>