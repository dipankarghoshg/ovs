                  ...
                  <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                      ...
                      <li class="menu-item-has-children dropdown">
                        ...
                        {
                        ?>
                        <a href="#" > <i class="menu-icon fas fa-eye"></i>Nominations</a>
                        <?php
                        }
                        ?>
                        <?php
                    ...
                    <div id="right-panel" class="right-panel">
                      ...
                      <header id="header" class="header">
                            ...
                            <div class="header-left">
                              ...
                              <div class="user-area dropdown float-right">
                                ...
                                <div class="user-menu dropdown-menu">
                                  ...
                                  ?></a>
                                  <?php
                                  $ve=DB::table('User_model')
                                  ->where('Email',session('Email'))->get();
                                  if ($ve[0]->hasverified==1) {
                                  ?>
                                  <a class="nav-link" ><i class="fa fa-power -off"></i>Email Verified</a>
                                  <?php
                                  }
                                  else{
                                  ?>
                                  <a class="nav-link" href="/views/inputcode.blade.php"><i class="fa fa-power -off"></i>Verify Email</a>
                                  <?php
                                  }
                                  ?>
                        ...
                        <div style=" font-family: 'Open Sans', sans-serif;">
                          ...
                          if($vot[0]->Votecnt==1) {
                          echo "You Have Given Vote Successfully.";?><br><?php
                          }
                          else{
                          }
                          ?>
                          ...
                          //dd($vDate[0]->date);
                          if ($vDate[0]->date== $date) {}
                          elseif ($vDate[0]->date<$date) {}
                          
                          else{
                          echo "Voting Process Will Begin Soon.";?><br><?php
                          }
                          ?>
                          <?php
                          //$date=Carbon::now()->toDateString();
                          ...
                          //dd($vDate[0]->date);
                          if ($vDate[0]->ResultCheck== 1) {
                          echo "Your Result has been published! Check it out";?><br><?php
                          }
                          else{
                        ...
                        <form name="f1" id="f1" action="">
                          <div class="sidebar-search">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control" placeholder="Search in page" name="Search">
                    ...
                    </html><?php /**PATH C:\Laravel\ovs\resources\views/user.blade.php ENDPATH**/ ?>