...
<html>
  ...
  <body>
    <header class="header">
      ...
      <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"><a href="/views/tables.blade.php"> <i class="icon-grid"></i>Candidates</a></li>
                ...
                <div class="row">
                  <div class="col-lg-6" style="width: 100%">
                    <div class="block margin-bottom-sm" style="width:1000px;">
                      <div class="title"><strong>Candidate Table</strong></div>
                      <style>
                      table {
                      ...
                      <table class="table" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row"><?php echo e($candidate->Cid); ?></th>
                            <td><?php echo e($candidate->Name); ?></td>
                            <td><?php echo e($candidate->Email); ?></td>
                            <td><?php echo e($candidate->CollegeId); ?></td>
                            <td><?php echo e($candidate->Stream); ?></td>
                            <td><?php echo e($candidate->Remarks); ?></td>
                            <td><?php echo e($candidate->Semno); ?></td>
                            <td><?php echo e($candidate->Post); ?></td>
                            <td>
                              <?php
                              ...
                              <td><a style="color:#78ff85; padding-left: 20px" href='/changeStatus/<?php echo e($candidate->Cid); ?>/1'>Allow</a></td>
                              <td><a style="color:#ff1f1f; padding-right: 20px"  href='/changeStatus/<?php echo e($candidate->Cid); ?>/-1'>Deny</a></td>
                            </tr>
      ...
      </html><?php /**PATH C:\Laravel\ovs\resources\views/tables.blade.php ENDPATH**/ ?>