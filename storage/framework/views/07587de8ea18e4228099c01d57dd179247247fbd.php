...
<html>
  ...
  <body>
    <header class="header">
        ...
        <nav id="sidebar">
          ...
          <ul class="list-unstyled">
            ...
            <li ><a href="/views/adminTablesUsers.blade.php"> <i class="icon-grid"></i>Users </a></li>
             <li class="active"><a href="/views/adminTablesCandidates.blade.php"> <i class="icon-grid"></i>Candidates </a></li>
          </nav>
          ...
          <div class="page-content">
            ...
            <div class="page-header no-margin-bottom">
              <div class="container-fluid">
                <h2 class="h5 no-margin-bottom">Candidte Tables</h2>
              </div>
            </div>
            <!-- Breadcrumb-->
            <div class="container-fluid">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Candidate Table           </li>
              </ul>
            </div>
                    ...
                    <div class="block margin-bottom-sm" style="width:1000px;">
                      ...
                      <table class="table" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row"><?php echo e($com->Cid); ?></th>
      ...
      </html><?php /**PATH C:\Laravel\ovs\resources\views/adminTablesCandidates.blade.php ENDPATH**/ ?>