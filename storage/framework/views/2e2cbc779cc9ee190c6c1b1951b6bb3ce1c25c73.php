            ...
            <header id="header" class="header">
              ...
              <form name="pacs" action="/postacs">
                <table>
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candiac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($candiac->Cid); ?></td>
                    <td><?php echo e($candiac->Name); ?></td>
                    <td><?php echo e($candiac->Post); ?></td>
                    <td><input type="radio" name="ACS" value="<?php echo e($candiac->Cid); ?>" required></td>
                  </tr>
              ...
              <!--=========================================script============================================--><?php /**PATH C:\Laravel\ovs\resources\views/voteACS.blade.php ENDPATH**/ ?>