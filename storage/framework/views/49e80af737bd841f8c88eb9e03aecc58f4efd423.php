                    ...
                    <div class="container">
                        <div class="signup-content">
                            <div class="signup-form">
                                ...
                                <?php endif; ?>
                                <form name="f1" method="post" enctype="multipart/form-data" class="register-form" id="register-form" action="<?php echo e(url('create')); ?>">
...
</html><?php /**PATH C:\Laravel\ovs\resources\views/Regestraion.blade.php ENDPATH**/ ?>