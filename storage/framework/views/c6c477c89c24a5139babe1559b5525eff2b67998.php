        ...
        <ul class="nav navbar-nav">
          ...
          <div id="right-panel" class="right-panel">
            ...
            <header id="header" class="header">
              ...
              <center>
              <div class="oops">
                <i class="fa fa-meh-o" aria-hidden="true">Oops! There is no voting process running in your college</i>
              </div>
              <style>
              table {
              ...
              <form name="pcs" action="/post" >
                <table>
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($candi->Cid); ?></td>
                    <td><?php echo e($candi->Name); ?></td>
                    <td><?php echo e($candi->Post); ?></td>
                    <td><input type="radio" name="CS" value="<?php echo e($candi->Cid); ?>" required></td>
                  </tr>
              ...
              <!--=========================================script============================================--><?php /**PATH C:\Laravel\ovs\resources\views/vote.blade.php ENDPATH**/ ?>