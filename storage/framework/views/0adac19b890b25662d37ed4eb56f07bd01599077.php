    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img src="/img/img2/avatar-6.jpg" alt="..." class="img-fluid rounded-circle"></div>
          <div class="title">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="/sa/tables.html"> <i class="icon-grid"></i>Tables </a></li>
                <li><a href="/sa/charts.html"> <i class="fa fa-bar-chart"></i>Charts </a></li>
              ...
              <div class="col-lg-6">                                           
                <div class="messages-block block">
                  ...
                  <div class="messages"><a href="#" class="message d-flex align-items-center">
                      <div class="profile"><img src="/img/img2/avatar-3.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="/img/img2/avatar-2.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="/img/img2/avatar-1.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="/img/img2/avatar-5.jpg" alt="..." class="img-fluid">
...
</html><?php /**PATH C:\Laravel\Project_Major\resources\views/admin.blade.php ENDPATH**/ ?>