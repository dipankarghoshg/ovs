                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <td><a style="color:#78ff85; padding-left: 20px" href='/changeStatus/{{$candidate->Cid}}/1'>Allow</a></td>
                              <td><a style="color:#ff1f1f; padding-right: 20px"  href='/changeStatus/{{$candidate->Cid}}/-1'>Deny</a></td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
