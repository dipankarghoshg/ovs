                  ...
                  <div class="col-lg-6">
                    <div class="messages-block block">
                      ...
                      <div class="messages"><a href="#" class="message d-flex align-items-center">
                        <div class="profile"><img src="/img/{{$data->Image}}" alt="..." class="img-fluid">
                          <div class="status online"></div>
                        </div>
                        
                        <div class="content">   <strong class="d-block">{{$data->Name}}</strong><span class="d-block">{{$data->CollegeName}}</span><small class="date d-block"><?php
                        switch ($data->Status) {
                        case "0":
                        echo "Pending";
                        break;
